...
public class ExceptionInterceptor extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(AccessNotHeritableException.class)
    public final ResponseEntity<Object> accountLockedExceptionException(AccessNotHeritableException exception){
    ...
    public final ResponseEntity<Object> handleAccountLockedException(AccountLockedException exception){
    ...
    public final ResponseEntity<Object> handleDuplicateReferenceException(DuplicateReferenceException exception){
